...
public abstract class AbstractTest {
    ...
    public static final String registrationPageUrl = "https://stellarburgers.nomoreparties.site/register";

    public static final String apiRegisterUrl = "https://stellarburgers.nomoreparties.site/api/auth/register";

    public static final String apiLoginUrl = "https://stellarburgers.nomoreparties.site/api/auth/login";
    public static final String apiDeleteUserUrl = "https://stellarburgers.nomoreparties.site/api/auth/login";
